x<link rel="stylesheet" href="plugins/css/bootstrap.css"/>
...
<div  class="container text-center" id="bootstrap">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="plugins/img/b2.jpg" alt="Primeiro Slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="plugins/img/b3.jpg" alt="Segundo Slide">
            </div>
    ...
    <h2 class="text-center m-3">Conhecendo o Bootstrap</h2>
    <div class="row">
        <div class="col-3">   
            <img class="img-fluid"src="plugins/img/b4.jpg" alt="" /> 

            <h5 class="badge-dark my-3 p-sm-2">TUTORIAL</h5>
            <ul class="list-group">

                <li class="list-group-item list-group-item-info"> <a class="btn badge-info w-100 mx-auto " href="https://www.youtube.com/watch?v=qPYCnebQQ6U" role="button">HTML-CSS-JS</a> </li>
                <li class="list-group-item list-group-item-info"> <a class="btn badge-info w-100 mx-auto " href="https://www.youtube.com/watch?v=EUQCjCydGco" role="button">NETBEANS</a> </li>
                <li class="list-group-item list-group-item-info"> <a class="btn badge-info w-100 mx-auto " href="https://www.youtube.com/watch?v=VdQklerIN2k" role="button">LARAGON</a> </li>
                <li class="list-group-item list-group-item-info"> <a class="btn badge-info w-100 mx-auto " href="https://www.youtube.com/watch?v=n_Pioo9JZXs" role="button">FILEZILLA</a> </li>
            </ul>

        </div>
        <div class="col">
            <h6 class="text-justify btn btn-light">
                O que é Bootstrap?
    ...
    <hr>
    <div class="row">
        <div class="col btn btn-light text-justify mb-3">
            <h4>Velocidade de desenvolvimento</h4>
            <h6>
        ...
        <div class="col btn btn-dark text-justify mb-3">
            <h4>Compatibilidade</h4>
            <h6>Esta característica é consequência do próprio surgimento do framework, visto que seus criadores queriam resolver os dilemas entre desenvolvimento e design, bem como padronizar e unificar o que se entrega ao usuário final, independente da plataforma e navegador que ele utilize. Na atual versão do Bootstrap, os mesmos resultados podem ser obtidos nos mais diversos e populares navegadores (Google Chrome, Firefox, Internet Explorer, Opera, Safari, etc.</h6>
        </div>
    ...
    <div class="row">
        ...
        <div class="col btn btn-dark text-justify mb-3">
            <h2 class="btn btn-danger w-25 mx-auto">Conclusão</h2>
            <h5>
